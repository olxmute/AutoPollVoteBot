...
class RemindersEditor:
    ...
    def _build_main_screen(self, handle: VoterHandle):
        ...
        markup = InlineKeyboardMarkup([
            [
                ...
                InlineKeyboardButton("Lead time", callback_data="rem:lead"),
            ],
            [
    ...
    async def _handle_lead(self, query: CallbackQuery, handle: VoterHandle) -> None:
        ...
        prompt = await query.message.reply_text(
            f"Reply with the desired lead time in hours (current: {hours}).",
    ...
    async def _on_lead_time_reply(self, _client: Client, message: Message) -> None:
        ...
        try:
            ...
            await message.reply_text("Please reply with a positive whole number of hours.")
            # Leave pending so the user can try again
            return
        ...
        await message.reply_text(f"Lead time updated to {hours} hours.")
        text, markup = self._build_main_screen(handle)
        await message.reply_text(text, reply_markup=markup)
